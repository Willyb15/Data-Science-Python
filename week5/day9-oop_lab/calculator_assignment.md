...
|   5   |  Push Value  | [ 6, 5 ]    |                                           |
|   3   |  Push Value  | [ 6, 5, 3 ] |                                           |
|   +   |     Add      | [ 6, 8 ]    | Pop two values (3, 5), push result (5 + 3)|
|   4   |  Push Value  | [ 6, 8, 4 ] |                                           |
|   /   |    Divide    | [ 6, 2 ]    | Pop two values (4, 8), push result (8 / 4)|
|   +   |     Add      | [ 8 ]       | Pop two values (2, 6), push result (6 + 2)|
|   3   |  Push Value  | [ 8, 3 ]    |                                           |
|   -   |   Subtract   | [ 5 ]       | Pop two values (3, 8), push result (8 - 3)|
|       |    Return    |   5         |                                           |
