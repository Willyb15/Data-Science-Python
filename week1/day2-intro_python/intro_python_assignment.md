...
2. Write a script that takes two user inputted numbers and prints "The first number is larger" or "The second number is larger" depend which is larger. (**Hint**: you'll need to use `raw_input()` twice.)
